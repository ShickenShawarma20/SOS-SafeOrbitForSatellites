/* SOS — Netlify Function: /.netlify/functions/debris
...
const DEBRIS_OBJECTS = [
  {
    ...
    origin: "Chinese ASAT Test (FY-1C)", sourceMission: "Fengyun-1C",
    eventDate: "2007-01-11", massKg: 85, sizeCategory: "medium",
    decayEstimate: "2035-2045", riskLevel: "critical",
    elements: {
  ...
  {
    id: "OBJ-3421", noradId: 41780, type: "payload",
    ...
    origin: "Russian Space Program", sourceMission: "Cosmos 2519 (US-KS)",
    eventDate: "2016-11-09", massKg: 1200, sizeCategory: "large",
    decayEstimate: "2040-2055", riskLevel: "high",
    elements: {
  ...
  {
    id: "OBJ-1123", noradId: 36411, type: "rocket_body",
    ...
    origin: "ISRO PSLV Launch Vehicle", sourceMission: "PSLV-C5 / RESOURCESAT-2",
    eventDate: "2011-04-20", massKg: 450, sizeCategory: "large",
    decayEstimate: "2028-2035", riskLevel: "medium",
    elements: {
  ...
  {
    id: "OBJ-7781", noradId: 42917, type: "fragmentation",
    ...
    origin: "Iridium-Cosmos Collision (2009)", sourceMission: "Cosmos 2251",
    eventDate: "2009-02-10", massKg: 12, sizeCategory: "small",
    decayEstimate: "2025-2030", riskLevel: "high",
    elements: {
  ...
  {
    id: "OBJ-9912", noradId: 44832, type: "unknown",
    ...
    origin: "Unknown — Pending Attribution", sourceMission: "Unknown",
    eventDate: "2019-09-01", massKg: 320, sizeCategory: "medium",
    decayEstimate: "No natural decay expected", riskLevel: "low",
    elements: {
...
exports.handler = async (event) => {
  ...
  if (path === "/" || path === "") {
    ...
    if (q) filtered = filtered.filter((d) =>
      ...
      d.noradId?.toString().includes(q) || d.origin.toLowerCase().includes(q) ||
      d.sourceMission.toLowerCase().includes(q)
    );

    return { statusCode: 200, headers, body: JSON.stringify({ items: filtered.slice((page - 1) * limit, page * limit), total: filtered.length, page, limit }) };
  }
  ...
  if (subRoute === "conjunctions") {
    return { statusCode: 200, headers, body: JSON.stringify(CONJUNCTIONS.filter((c) => c.objectId === debris.id)) };
  }
  if (subRoute === "geometry") {
    return { statusCode: 200, headers, body: JSON.stringify({ id: debris.id, noradId: debris.noradId, type: debris.type, orbitalElements: debris.elements, orbitRing: [] }) };
  }

  return { statusCode: 200, headers, body: JSON.stringify(debris) };
};
